...
def MainPage():
    ...
    bt.grid(column=0)
    bt = Button(frame, text='Edit Book', fg=fgColor, bg="#24d1bc", width=50,
                command=lambda: ShowFrame(frame, EditBookPage))
    bt.grid(column=0)
...
def SearchBookPage(Criteria='BookName'):
    ...
    SearchBt = Button(frame, text='Search',bg="#24d1bc",width=10)
    ...
    ChgSearchBt = Button(frame, text='Change Search Criteria', bg="#24d1bc")
    ...
    Button(frame, text='Back', bg="#24d1bc", width=10, command=lambda: ShowFrame(frame, MainPage)).grid(column=0, row=2)
    ChgSearchBt.grid(column=0, row=3, width=5)
    Button(frame, text='Borrow', bg="#24d1bc", width=10, command=lambda: ShowFrame(frame.destroy(), BorrowBookPage(ISBNVar.get(), BookNameVar.get()))).grid(column=1, row=3)
    instance = lambda: SearchBook(ISBN=ISBNVar.get(), ExactMatch=True)
    Button(frame, text='Edit', bg="#24d1bc", width=10,
...
def RegisterUserPage():
    ...
    Button(frame, text='Register', bg="#24d1bc", width=10, command=GetEntryInfo).grid(row=3, column=1, padx=50)
    Button(frame, text='Back', bg="#24d1bc", width=10, command=lambda: ShowFrame(frame, MainPage)).grid(row=3,
                                                                                                             column=0,
                                                                                                             padx=50)
