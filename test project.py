...
def SearhBookPage():
    ...
    Label(frame, text="Enter the Book Name: ").grid(row=0)
...
def RegisterUserPage():
    ...
    Button(frame, text='Register', bg="navajo white", width=10, command=GetEntryInfo).grid(row=2, column=1, padx=50)
    Button(frame, text='Back', bg="navajo white", width=10, command=lambda: ShowFrame(frame, MainPage)).grid(row=2,
                                                                                                             column=0,
                                                                                                             padx=50)
